...
if __name__ == "__main__":
    ...
    def setup_gui():
        ...
        start_date_entry = DateEntry(date_col, width=12, background='darkblue', foreground='white', borderwidth=2, year=2026, firstweekday='sunday')
        ...
        globals()['show_employee_hint'] = show_employee_hint
        globals()['emp_frame'] = emp_frame
